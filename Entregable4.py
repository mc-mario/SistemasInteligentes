...
class Accion():
    ...
    def __repr__(self):
        return f"{self.accion} P{self.probabilidad} -> {self.nuevo_estado}"
...
def iteracion_valores(gamma, nodos, epsilon = 0.01):
    ...
    while True:
        ...
        for nodo in nodos:
            ...
            u_prime = list(map(lambda x: x.utilidad(), nodo.acciones))
